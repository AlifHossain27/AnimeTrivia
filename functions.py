...
with urlopen("https://opentdb.com/api.php?amount=50&category=31&difficulty=medium&type=multiple") as webpage:
...
def is_correct(btn):
    # a function to evaluate wether user's answer is correct
...
def frame3():
    ...
    score = QLabel("100")
    score.setStyleSheet(
        "font-size: 100px; color: #8FC740; margin: 0 75px 0px 75px;")
    widgets["score"].append(score)

    # go back to work widget
    message2 = QLabel("OK. Now go watch some Anime.")
